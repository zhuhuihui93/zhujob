	...
	<div class="mui-content">
		 <div class="mui-slider">
		    <div class="mui-slider-indicator mui-segmented-control mui-segmented-control-inverted my-monthly-card-tit">
		        <a href="#item1" class="mui-control-item myTabItem">购买月卡</a>
		        <a href="#item2" class="mui-control-item myTabItem mui-active">月卡列表</a>
		    </div>
	        <div class="mui-slider-group" style="width: 100%;">
	            <div id="item1" class="mui-slider-item mui-control-content card-list ">
	            	...
	            	<div class="Buy-monthly-btn">
	            		<button class="mui-btn mui-btn-outlined" id="buy_month_card1">购买</button>
	            	</div>
	            </div>
	            <div id="item2" class="mui-slider-item mui-control-content my-card-list card-list mui-active">
	               <?php if(!empty($list[month]) ): ?><ul class="mui-table-view">	                	
...
<script type="text/javascript">
	...
	/* 月卡 */
	$('#buy_month_card1').click(function(){
		var money = 45;
		var type = 3;
		var body = '购买月卡';
