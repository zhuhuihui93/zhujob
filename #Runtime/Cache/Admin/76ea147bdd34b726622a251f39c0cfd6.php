...
<table id="<?php echo html_id('datagrid');?>" data-menu="#<?php echo html_id('datagrid-menu');?>" data-toolbar="#<?php echo html_id('datagrid-toolbar');?>" data-title="<?php echo ($title); ?>" data-url="<?php echo U(CONTROLLER_NAME . '/' . ACTION_NAME, array('grid'=>'datagrid'));?>">
	<thead>
		<tr>
			...
			<th data-options="field:'recharge_money',width:100,sortable:true">充值金额(元)</th>
			<th data-options="field:'create_time',width:250,sortable:true">充值时间</th>
		</tr>
	</thead>
</table>
...
<div id="<?php echo html_id('datagrid-toolbar');?>">
	...
	<div>
		...
		<a class="easyui-linkbutton di2 toolbar-action iconCls="fa fa-search" plain="true""><span class="sp1">积分充值总金额(次)</span></br><span class="sp2"><?php echo ($integral_sum); ?></span></br><span class="sp3">积分充值总金额</span></a>
	</div>
