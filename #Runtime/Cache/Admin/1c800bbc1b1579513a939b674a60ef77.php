<?php if (!defined('THINK_PATH')) exit();?><form class="dialog-form-page">
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			<td width="80">角色名称：</td>
			<td><input class="easyui-validatebox" type="text" name="info[rolename]" data-options="required:true,validType:['length[2,20]','remote[\'<?php echo U('User/public_checkRoleName');?>\',\'rolename\']']" style="width:220px" /></td>
		</tr>
		<tr>
			<td>角色描述：</td>
